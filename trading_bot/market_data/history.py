...
from trading_bot.market_data.client import parse_data_feed
...
def fetch_daily_bars(
    ...
    """Download daily adjusted bars for the configured or requested symbol.
    ...
    requested_symbol = (symbol or settings.symbol).strip().upper()

    request = StockBarsRequest(
        symbol_or_symbols=requested_symbol,
    ...
    if isinstance(data_frame.index, pd.MultiIndex):
        ...
        data_frame = data_frame.xs(requested_symbol, level=symbol_level)
