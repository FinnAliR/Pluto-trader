...
from backtester import BacktestResult, results_to_summary_frame, run_backtest
...
def run_single_backtest(
    ...
    data = price_data if price_data is not None else load_daily_price_data(loaded_settings, start_date, end_date)
