...
def print_report_summary(
    ...
    print_top_table("Missed best market days", missed_days[missed_days["missed_by_strategy"]].head(5))
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Market symbol to analyze. Default: SPY.",
    )
    parser.add_argument(
        "--start",
    ...
    parser.add_argument(
        ...
        help=f"Number of strongest market days to inspect. Default: {DEFAULT_TOP_DAYS}",
    )
    parser.add_argument(
        "--short-trade-days",
        type=int,
    ...
    parser.add_argument(
        ...
        help="Flag absolute daily market moves at or above this value. Default: 0.10",
    )
